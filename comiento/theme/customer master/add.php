 		...
 		<table align="center">
 			...
 			<tr>
 				<div class="form-group">
		    		...
		    		<td><input type="tel" name="phone" value="<?php echo ($phone)?$phone:""; ?>"class="form-control" id="name" placeholder="Enter Mobile Number" maxlength="10">
		  			</td>
		  		<tr><td>
 			...
 			<tr>	
				<div class="form-group">
		    		...
		    		<td><input type="password" name="password" class="form-control" placeholder="Enter password" id="password"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
		  			</td>
		  		<tr><td>
